...
public class Principal {
     public static void main(String[] args) throws IOException {
        ...
        gerador.gerarArquivo("..\\TemplateMethod\\src\\templateMethod\\arquivos\\Criptografado.txt", mapa);
        
        GeradorArquivo gerador2 = new GeradorXmlCompactado();
        gerador.gerarArquivo("..\\TemplateMethod\\src\\templateMethod\\arquivos\\Xml.zip", mapa);
